...
public class GroupProjectNewOrOld extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GroupProjectNewOrOld frame = new GroupProjectNewOrOld();
				...
				if(filenameR.equals(".txt")){
					...
					lblShowProjectError.setText("ERROR: file does not exist. Please enter again.");
						...
						try {
							...
							double finalCost = finalCost(HR_PRICE, totalTime);
